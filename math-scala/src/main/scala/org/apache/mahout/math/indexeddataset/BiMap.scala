...
class BiDictionary[K, V] (
  ...
  def take(n: Int) = BiDictionary(m.take(n))
...
object BiDictionary {
  ...
  def apply[K, V](x: Map[K, V]): BiDictionary[K, V] = new BiDictionary(x)
   ...
   * @return a BiDictionary[String, Int] with added mappings
   */
  def append(keys: Set[String], biDi: BiDictionary[String, Int]): BiDictionary[String, Int] = {
   ...
   * @return a BiDictionary[String, Int] with added mappings
   */
  def append(keys: List[String], biDi: BiDictionary[String, Int]): BiDictionary[String, Int] = {
   ...
   */
  def stringInt(keys: Set[String]): BiDictionary[String, Int] = {
   ...
   */
  def create(): BiDictionary[String, Int] = {
