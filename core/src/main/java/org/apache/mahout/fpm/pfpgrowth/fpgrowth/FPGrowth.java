...
public class FPGrowth<A extends Comparable<? super A>> {
  ...
  private FrequentPatternMaxHeap growth(FPTree tree, MutableLong minSupportMutable, int k,
  ...
  private FrequentPatternMaxHeap growthBottomUp(FPTree tree, MutableLong minSupportMutable, int k,
