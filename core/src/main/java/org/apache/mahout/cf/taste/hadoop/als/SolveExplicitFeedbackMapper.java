...
class SolveExplicitFeedbackMapper extends Mapper<IntWritable,VectorWritable,IntWritable,VectorWritable> {
  ...
  protected void setup(Context ctx) throws IOException, InterruptedException {
    ...
    UorM = ALS.readMatrixByRows(UOrIPath, ctx.getConfiguration());
