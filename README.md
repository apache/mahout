...
```
        scala> timeSparseDRMMMul(1000,1000,1000,1,.02,1234L)
            {...} res3: Long = 16321
```
Note the 0.14 release is missing a class required for this; will be fixed in 0.14.1. We can see that the JVM only version is rather slow, thus our motive for GPU and Native Multithreading support.
