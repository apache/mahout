...
redirect_from:
    - /docs/latest/algorithms/map-reduce/classification/locally-weighted-linear-regression
    - /docs/latest/algorithms/map-reduce/classification/locally-weighted-linear-regression.html
---
