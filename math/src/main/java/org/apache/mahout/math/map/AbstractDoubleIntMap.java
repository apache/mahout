...
public abstract class AbstractDoubleIntMap extends AbstractMap {
   ...
   * @return the first key for which holds <tt>get(key) == value</tt>; returns <tt>Double.NaN</tt> if no such key
   *         exists.
   */
   ...
   * <i>identical</i> to the order used by method {@link #forEachKey(DoubleProcedure)}. <p> This method can be used to
   ...
   * be <i>identical</i> to the order used by method {@link #forEachKey(DoubleProcedure)}. <p> This method can be used
  ...
  public void pairsSortedByValue(DoubleArrayList keyList, IntArrayList valueList) {
    ...
    //org.apache.mahout.math.map.OpenDoubleIntHashMap.hashCollisions = 0;
    GenericSorting.quickSort(0, keyList.size(), comp, swapper);
    //log.info("collisions="+org.apache.mahout.math.map.OpenDoubleIntHashMap.hashCollisions);
  }
