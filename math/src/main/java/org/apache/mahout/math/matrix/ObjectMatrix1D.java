...
public abstract class ObjectMatrix1D<T> extends AbstractMatrix1D {
   ...
   * terminators are <tt>a(1) == f(get(0),other.get(0)), a(0)==null</tt>. <p> <b>Example:</b>
   * <pre>
   * org.apache.mahout.math.jet.math.Functions F = org.apache.mahout.math.jet.math.Functions.functions;
   * x = 0 1 2 3
   * y = 0 1 2 3
   ...
   * also at least an ObjectMatrix1D, both matrices have the same size, and all corresponding pairs of cells in the two
   ...
   * example, if the receiver is an instance of type <tt>DenseObjectMatrix1D</tt> the new matrix must also be of type
   * <tt>DenseObjectMatrix1D</tt>, if the receiver is an instance of type <tt>SparseObjectMatrix1D</tt> the new matrix
   * must also be of type <tt>SparseObjectMatrix1D</tt>, etc. In general, the new matrix should have internal
   ...
   * <i>stable</i>. For further information, see {@link org.apache.mahout.math.matrix.objectalgo.Sorting#sort(ObjectMatrix1D)}.
   * For more advanced sorting functionality, see {@link org.apache.mahout.math.matrix.objectalgo.Sorting}.
   *
