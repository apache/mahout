...
class GenericSortingTest {
  ...
  public static void demo1() {
    ...
    final int[] x = {3, 2, 1};
    final double[] y = {3.0, 2.0, 1.0};
    final double[] z = {6.0, 7.0, 8.0};
  ...
  public static void demo2() {
    ...
    final int[] x = {6, 7, 8, 9};
    final double[] y = {3.0, 2.0, 1.0, 3.0};
    final double[] z = {5.0, 4.0, 4.0, 1.0};
  ...
  /**
   * Checks the correctness of the partition method by generating random input parameters and checking whether results
   * are correct.
   */
  public static void testRandomly(int runs) {
    ...
    for (int run = 0; run < runs; run++) {
      ...
      org.apache.mahout.matrix.matrix.DoubleMatrix2D A1 =
          new org.apache.mahout.matrix.matrix.impl.DenseDoubleMatrix2D(size, size);
      ...
      int c = 0;
      org.apache.mahout.matrix.matrix.DoubleMatrix2D S1 =
          org.apache.mahout.matrix.matrix.doublealgo.Sorting.quickSort.sort(P1, c);
      org.apache.mahout.matrix.matrix.DoubleMatrix2D S2 =
          org.apache.mahout.matrix.matrix.doublealgo.Sorting.mergeSort.sort(P2, c);
