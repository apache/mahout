...
public abstract class ObjectMatrix2D extends AbstractMatrix2D {
   ...
   * f(get(0,0)), a(0)==null</tt>. <p> <b>Example:</b>
   * <pre>
   ...
   * )</tt> and terminators are <tt>a(1) == f(get(0,0),other.get(0,0)), a(0)==null</tt>. <p> <b>Example:</b>
   * <pre>
   * org.apache.mahout.jet.math.Functions F = org.apache.mahout.jet.math.Functions.functions;
   * x == 2 x 2 matrix
   * 0 1
   ...
   * @see org.apache.mahout.jet.math.Functions
   */
  public Object aggregate(ObjectMatrix2D other, org.apache.mahout.matrix.function.ObjectObjectFunction aggr,
   ...
   * also at least an ObjectMatrix2D, both matrices have the same size, and all corresponding pairs of cells in the two
   ...
   * rows and columns. For example, if the receiver is an instance of type <tt>DenseObjectMatrix2D</tt> the new matrix
   * must also be of type <tt>DenseObjectMatrix2D</tt>, if the receiver is an instance of type
   ...
   * matrix.viewSelection(
   * &nbsp;&nbsp;&nbsp;new ObjectMatrix1DProcedure() {
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public final boolean apply(ObjectMatrix1D m) { return
   ...
   * org.apache.mahout.matrix.matrix.objectalgo.Sorting#sort(ObjectMatrix2D,int)}. For more advanced sorting
   * functionality, see {@link org.apache.mahout.matrix.matrix.objectalgo.Sorting}.
   *
