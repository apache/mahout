...
@Deprecated
public abstract class AbstractDoubleList extends AbstractList<Double>
    implements org.apache.mahout.matrix.buffer.DoubleBufferConsumer {
   ...
   */
  @Override
  public void replaceFromWith(int from, Collection<Double> other) {
    checkRange(from, size());
    Iterator<Double> e = other.iterator();
    int index = from;
