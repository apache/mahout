...
class QRTest {
  ...
  public static void main(String[] args) {
    ...
    DoubleFactory2D myfactory = DoubleFactory2D.dense;
    DoubleMatrix2D xmatrix = myfactory.make(8, 2);
    DoubleMatrix2D ymatrix = myfactory.make(8, 1);
    ...
    DoubleMatrix2D zmatrix = myAlgebra.solve(xmatrix, ymatrix);
