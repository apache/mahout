...
class BenchmarkKernel {
  ...
  public static String systemInfo() {
    ...
    // build string matrix
    org.apache.mahout.matrix.matrix.ObjectMatrix2D matrix =
        new org.apache.mahout.matrix.matrix.impl.DenseObjectMatrix2D(properties.length, 2);
    ...
    // format matrix
    org.apache.mahout.matrix.matrix.objectalgo.Formatter formatter =
        new org.apache.mahout.matrix.matrix.objectalgo.Formatter();
