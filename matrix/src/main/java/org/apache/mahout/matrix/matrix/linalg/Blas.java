...
public interface Blas {
   ...
   */
  void assign(DoubleMatrix2D A, org.apache.mahout.matrix.function.DoubleFunction function);
   ...
   * @see org.apache.mahout.jet.math.Functions
   */
  void assign(DoubleMatrix2D x, DoubleMatrix2D y, org.apache.mahout.matrix.function.DoubleDoubleFunction function);
  ...
  /**
   * Combined vector scaling; <tt>y = y + alpha*x</tt>. In fact equivalent to <tt>y.assign(x,org.apache.mahout.jet.math.Functions.plusMult(alpha))</tt>.
   *
  ...
  /**
   * Combined matrix scaling; <tt>B = B + alpha*A</tt>. In fact equivalent to <tt>B.assign(A,org.apache.mahout.jet.math.Functions.plusMult(alpha))</tt>.
   *
   * @param alpha a scale factor.
