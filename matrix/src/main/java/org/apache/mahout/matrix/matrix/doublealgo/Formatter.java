...
// parameters
    double[] values = {
        ...
        5, 0.0, -0.0, -Double.NaN, Double.NaN, 0.0 / 0.0, Double.MIN_VALUE, Double.MAX_VALUE, Double.NEGATIVE_INFINITY,
...
//String[] javaStrings = new String[size];
  ...
  public static void demo3(int size, double value) {
    ...
    timer.reset().start();
    org.apache.mahout.matrix.matrix.impl.Former format =
...
//String[] rowNames = { "SunJDK1.2.2 classic", "IBMJDK1.1.8"};
    ...
    DoubleMatrix2D matrix = org.apache.mahout.matrix.matrix.DoubleFactory2D.dense.make(values);
    System.out.println("\n\n" + new Formatter("%G").toTitleString(matrix, rowNames, columnNames, "rowAxis", "colAxis",
...
//String[] rowNames = { "SunJDK1.2.2 classic", "IBMJDK1.1.8"};
    ...
    System.out.println(
        new Formatter("%G").toTitleString(org.apache.mahout.matrix.matrix.DoubleFactory2D.dense.make(values), rowNames,
...
//System.out.println(new Formatter().toSourceCode(org.apache.mahout.matrix.matrix.DoubleFactory2D.dense.make(values)));
    ...
    System.out.println(
        new Formatter().toTitleString(org.apache.mahout.matrix.matrix.DoubleFactory2D.dense.make(values), rowNames,
            columnNames, "vendor", "density", "title"));
  }
