 ...
 * {@link org.apache.mahout.matrix.function.DoubleFunction}, binary functions of type {@link
 * org.apache.mahout.matrix.function.DoubleDoubleFunction}. All can be retrieved via <tt>public static final</tt>
 * variables named after the function. Unary predicates are of type {@link org.apache.mahout.matrix.function.DoubleProcedure},
 * binary predicates of type {@link org.apache.mahout.matrix.function.DoubleDoubleProcedure}. All can be retrieved via
...
public class Functions {
  ...
  */
   ...
   * (excluding 0.0 and 1.0). Currently the engine is {@link org.apache.mahout.jet.random.engine.MersenneTwister} and is
   * seeded with the current time. <p> Note that any random engine derived from {@link
   * org.apache.mahout.jet.random.engine.RandomEngine} and any random distribution derived from {@link
   * org.apache.mahout.jet.random.AbstractDistribution} are function objects, because they implement the proper
