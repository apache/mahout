...
// your favourite distribution goes here
    org.apache.mahout.jet.random.AbstractDistribution dist =
        new org.apache.mahout.jet.random.Gamma(alpha, lambda, engine);
...
//System.out.println(bin);
   ...
   *
   * @param args [0] the number of random numbers to be generated per subclass. [1] <tt>true</tt> prints each generated
   *             number, <tt>false</tt> does not print generated numbers (use this setting for benchmarking).
   */
   ...
   * @param print <tt>true</tt> prints each generated number, <tt>false</tt> does not print generated numbers (use this
  ...
  public static void random(int size, boolean print, double mean, String generatorName) {
    ...
    try {
      gen = Class.forName(generatorName).asSubclass(RandomEngine.class).newInstance();
