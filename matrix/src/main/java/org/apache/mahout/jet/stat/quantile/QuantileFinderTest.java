          ...
          for (double delta : deltas) {
            for (int knownCounter = 0; knownCounter < 2; knownCounter++) {
              ...
              DoubleQuantileFinder finder =
                  QuantileFinderFactory.newDoubleQuantileFinder(known_N, N, epsilon, delta, p, null);
    ...
    if (computeExactQuantilesAlso) {
      ...
      */
      ...
      DoubleArrayList observedEpsilons =
          observedEpsilonsAtPhis(new DoubleArrayList(phis), (ExactDoubleQuantileFinder) exactFinder, approxFinder,
              epsilon);
